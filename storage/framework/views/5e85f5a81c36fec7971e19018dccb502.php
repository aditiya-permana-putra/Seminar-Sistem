...
<div class="card mt-4">
    <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"> 
                            <?php if($item->direktur_approved == 'Pending'): ?>
                            <span class="badge badge-warning"> <i class="fas fa-check"></i> Disetujui Oleh Manager Operational</span>
                            <?php elseif($item->direktur_approved == 'Approved by Direktur'): ?>
                                <span class="badge badge-success"> <i class="fas fa-check"></i> Approved</span>
                            <?php elseif($item->direktur_approved == 'Rejected by Direktur'): ?>
                                <span class="badge badge-danger"> <i class="fas fa-times"></i> Rejected</span>
                            <?php endif; ?>
                        </td>
                        <td class="text-center">
                            <!-- Form untuk approve -->
                            <form action="<?php echo e(route('approve_direktur', ['id' => $item->id])); ?>" method="POST" style="display: inline;">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn btn-success btn-sm"> <i class="fas fa-check"></i> Approve</button>
                            </form>
                            <!-- Form untuk reject -->
                            <form action="<?php echo e(route('reject_direktur', ['id' => $item->id])); ?>" method="POST" style="display: inline;">
                                <?php echo csrf_field(); ?>
        ...
        <a href="<?php echo e(route('direktur.index')); ?>" class="btn btn-primary btn-sm"> <i class="fas fa-save"></i> Simpan</a>
    </div>
</div>
    
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MAGANG\Fix\resources\views/pages/direktur/show.blade.php ENDPATH**/ ?>