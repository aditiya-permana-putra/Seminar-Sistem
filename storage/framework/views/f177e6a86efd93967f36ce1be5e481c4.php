                ...
                <tbody>
                    <?php $__currentLoopData = $nomorSurat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php if($surat->manager_klinik_approved == 'Terverifikasi oleh Manager Klinik'): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MAGANG\Fix\resources\views/pages/permintaan/index.blade.php ENDPATH**/ ?>