                ...
                <tbody>
                    <?php $__currentLoopData = $nomorsurat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('manager-klinik.show', $surat->id)); ?>" class="btn btn-info btn-sm"> <i class="fas fa-eye"></i> Lihat Permintaan</a>
                               
                                <!-- Form untuk approve -->
                                <form action="<?php echo e(route('approve_surat', ['id' => $surat->id])); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MAGANG\Fix\resources\views/pages/manager-klinik/index.blade.php ENDPATH**/ ?>