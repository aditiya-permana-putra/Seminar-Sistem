                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cetak-surat')): ?>
                                <a href="<?php echo e(route('cetak-surat.show', $surat->id)); ?>" class="btn btn-info btn-sm">Lihat</a>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cetak-surat')): ?>
                                <form action="<?php echo e(route('buat-surat.destroy', $surat->id)); ?>" method="post"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\.Sistem Cuti Karyawan\Sistem Pengajuan Kerusakan Barang FIX\resources\views/pages/cetak-surat/index.blade.php ENDPATH**/ ?>