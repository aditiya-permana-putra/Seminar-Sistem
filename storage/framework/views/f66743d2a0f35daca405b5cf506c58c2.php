...
<?php $__env->startSection('title', 'Memo Persetujuan'); ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if($surat->direktur_approved == 'Terverifikasi oleh Direktur'): ?>
                                    <span class="badge badge-success"> <i class="fas fa-check"></i> Disetujui oleh Direktur</span>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MAGANG\Fix\resources\views/pages/memo-persetujuan/index.blade.php ENDPATH**/ ?>