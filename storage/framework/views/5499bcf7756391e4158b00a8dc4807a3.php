...
<form action="<?php echo e(route('surat-permintaan.update', $nomorSurat->id)); ?>" method="POST">
    <?php echo csrf_field(); ?>
    ...
    <div class="card mt-2">
        <div class="card-body">
            ...
            <a href="<?php echo e(route('surat-permintaan.index')); ?>" class="btn btn-danger mt-3"> <i class="fa fa-arrow-left"></i> Kembali</a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MAGANG\Fix\resources\views/pages/surat-permintaan/edit.blade.php ENDPATH**/ ?>