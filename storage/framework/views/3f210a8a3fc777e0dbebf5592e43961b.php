...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?php echo e(route('pengajuan-surat.index')); ?>" class="btn btn-primary">Kembali</a>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('approve-manager-klinik')): ?>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('barang.approve', $barang->id)); ?>"
                                                                method="post">
                                                                <?php echo csrf_field(); ?>
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="exampleModal<?php echo e($barang->id); ?>" tabindex="-1"
                                                aria-labelledby="exampleModalLabel<?php echo e($barang->id); ?>" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel<?php echo e($barang->id); ?>">
                                                                Tolak Barang</h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('barang.reject', $barang->id)); ?>"
                                                                method="post">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="form-group">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\.Sistem Cuti Karyawan\Sistem Pengajuan Kerusakan Barang FIX\resources\views/pages/pengajuan-surat/show.blade.php ENDPATH**/ ?>