...
<form action="<?php echo e(route('permintaan.update', $nomorSurat->id)); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($nomorSurat->nomor_surat); ?>"  placeholder="Masukkan Nomor Surat">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var i = <?php echo e(count($barang)); ?>; // Menetapkan nilai awal i dengan jumlah baris barang yang sudah ada
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MAGANG\Pengadaan-barang\Pengadaan-barang\resources\views/pages/permintaan/edit.blade.php ENDPATH**/ ?>