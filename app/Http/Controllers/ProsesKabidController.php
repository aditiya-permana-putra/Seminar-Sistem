...
class ProsesKabidController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('pages.proses-kabid.index', compact('suratList'));
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.proses-kabid.show', compact('surat', 'barang'));
    }
    ...
    public function update(string $id)
    {
        ...
        $surat->status = 'Selesai Di Proses Kepala Bidang';
        $surat->save();
